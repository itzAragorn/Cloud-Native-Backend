...
public class GlobalExceptionHandler {
    ...
    /**
     * Manejo de UsuarioNotFoundException
     */
    @ExceptionHandler(UsuarioNotFoundException.class)
    public ResponseEntity<ErrorResponse> manejarUsuarioNotFoundException(
    ...
    public ResponseEntity<ErrorResponse> manejarEmailDuplicadoException(
